...
<script language="javascript">alert('Ошибка при копировании файла');</script>
      <?php 
            ...
            $flnm = time().'.';
             ...
             $new_imgfile = $document_root."/images/slides/img". $flnm.$filetype;
            ...
            $query = "INSERT INTO some_items (user_id, name) VALUES ($user_id, $url)";
...
//               echo "slide_id => $insid";
    ...
    document.write ('<form action="index.php?act=addsu" method="post"><input name="slide_id" type="hidden" value="<?php echo $insid;?>"/></form>');
